...
> Version `3.0.0` — Written 100% in Luau from scratch.
...
- **All major components** — Button, Toggle, Slider, Dropdown, Multi Dropdown, Input, Keybind, ColorPicker, Paragraph, Section
...
- **Memory safe** — disconnects all connections on `Window:Destroy()`
